...
export const LatestForumPosts = () => {
    const {t} = useTranslation()
  return (
    <SectionContainer className='flex flex-col gap-[22px] items-center m-components_distance'>
        <h1 className='text-[34px] font-bold font-roboto dark:text-white text-black'>{t('latestforumposts')}</h1>
